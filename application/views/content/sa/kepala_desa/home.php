        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Daftar Kepala Desa
                        ...
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <?php foreach ($kepala_desa as $value) : ?>
                                    <tr>
                                        <th scope="row"><?= $no ?></th>
                                        <td width="20"><img style="max-height: 300px; max-width: 200px;" src="<?php echo base_url('assets/admin/upload/kepala_desa/' . $value['foto']); ?>" class="rounded" alt="..."></td>
                                        <td><?= $value['nama']; ?></td>
                                        <td><?= $value['periode']; ?></td>
                                        <td><?= $value['sambutan']; ?></td>
                                        <td align="center">
                                            <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-toggle="tooltip" data-placement="bottom" title="Edit Data" data-target="#editmodal<?php echo $value['id_kepala_desa']; ?>">
                                                <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pencil-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456l-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
                                                    <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z" />
                                                </svg>
                                            </button>
                                            <a class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="bottom" title="Hapus Data" href="<?php echo base_url() ?>sa/kepala_desa/hapus_data/<?php echo $value['id_kepala_desa']; ?>" role="button">
